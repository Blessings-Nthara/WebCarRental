...
<body style="background-color:powderblue">
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="White" Height="103px" Width="1377px" style="margin-top: 0px">
            <div class="auto-style4">
                <span class="auto-style6">CAR RENTAL COMPANY ADMINSTRATION</span><span class="auto-style1"><br /> <br /> 
                <asp:Menu ID="Menu2" runat="server" CssClass="auto-style7" Height="16px" Orientation="Horizontal" Width="173px">
